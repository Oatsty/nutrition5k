...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--data-name", type=str, help='Dataset name. Only nutrition5k is implemented')
    parser.add_argument("--imgs-dir", type=str, help='Image directory path')
    parser.add_argument("--metadatas-path", type=str, help='metadata path (csv file)')
    parser.add_argument("--splits-train-path", type=str, help='train ids txt file path')
    parser.add_argument("--splits-test-path", type=str, help='test ids txt file path')
    parser.add_argument("--model-name", type=str, help='model name')
    parser.add_argument("--pretrained-model", type=str, help='pretrained model name')
    parser.add_argument("--mask-weight", type=float, help='mask_ratio')
    parser.add_argument("--dropout-rate", type=float, help='drop-out rate')
    parser.add_argument("--train-loss", type=str, help='loss function')
    parser.add_argument("--batch-size", type=int, help='batch size')
    parser.add_argument("--lr", type=float, help='learning rate')
    parser.add_argument("--lp", type=float, help='Lp loss p parameter')
    parser.add_argument("--num-epochs", type=int, help='number of total epochs')
    parser.add_argument("--warmup-epochs", type=int, help='number of warmup epochs (only required for noisy trainer)')
    parser.add_argument("--noise-removal-epochs", type=int, help='noise removal epochs (only required for noisy trainer)')
    parser.add_argument("--remove-rate", type=float, help='removal rate (only required for noisy trainer)')
    parser.add_argument("--removal-weight", type=float, help='removal weight (only required for noisy trainer)')
    parser.add_argument("--weight-decay", type=float, help='weight decay')
    parser.add_argument("--ckpt", type=str, help='model resume checkpoint')
    parser.add_argument("--finetune", action="store_true", help='unused')
    parser.add_argument("--layers", type=int, help='unused')
    parser.add_argument("--trainer", type=str, help='trainer name')
    parser.add_argument("--scheduler-warmup", type=int, help='scheduler warmup epoch numbers')
    parser.add_argument("--eval-height", type=int, help='evaluation image height')
    parser.add_argument("--eval-width", type=int, help='evaluation image width')
    parser.add_argument("--save-path", type=str, help='model save path')
    parser.add_argument("--cfg", type=str, help='config file path')
    parser.add_argument("--title", type=str, nargs="+", help='logger title')
