...
class Nutrition5kColorDataset(BaseDataset):
    def __init__(self, *args, **kwargs) -> None:
        super(Nutrition5kColorDataset, self).__init__(*args, **kwargs)
        self.metadatas_dict: dict[str, Metadata] = {}
        self.init_metadatas()
        transform_depth = kwargs.get("transform_depth")
    ...
    def __getitem__(self, index: int) -> dict[str, Any]:
        ...
        depth_path = Path.joinpath(img_dir, "depth_color.png")
    ...
    **kwargs,
    ...
    splits_train = list(
        filter(
            ...
            and imgs_dir_p.joinpath(t, "depth_color.png").is_file()
    ...
    if unnormalized_int_tensor or model_name == "openseed":
        ...
        transform = None
    train_dataset = Nutrition5kColorDataset(
        imgs_dir_p,
        metadatas_path_p,
        splits_train,
        transform=transform,
    ...
    test_dataset = Nutrition5kColorDataset(
        imgs_dir_p,
        metadatas_path_p,
        splits_test,
        transform=transform,
