...
from .nutrition5k_color_dataset import make_dataset as make_nutrition5k_color_dataset
...
def make_dataset(config: CN, **kwargs) -> dict[str, BaseDataset]:
    ...
    elif dataset_name == "nutrition5kcolor":
        return make_nutrition5k_color_dataset(config, **kwargs)
