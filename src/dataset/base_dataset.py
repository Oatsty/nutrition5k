...
class BaseDataset(Dataset):
    def __init__(self, imgs_dir: Path, metadatas_path: Path, splits: list[str], transform: Optional[transforms.Normalize] = None, transform_depth: Optional[transforms.Compose] = None, normalize_depth: Optional[transforms.Compose] = None) -> None:
